    ...
    if (!task) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
                ...
                <Link href="/campnav/assignments" className="text-primary text-sm font-semibold">← Back to Assignments</Link>
            </div>
        )
    }
                ...
                <div className="flex gap-3">
                    ...
                    {user.role === "camp-staff" && (
                        <>
                            ...
                            {canComplete && (
                                <button
                                    onClick={() => completeTask({ id: task._id }).then(() => router.push("/campnav/assignments"))}
                    ...
                    {(task.status === "completed" || task.status === "rated") && (
                        <button
                            onClick={() => router.push("/campnav/assignments")}
