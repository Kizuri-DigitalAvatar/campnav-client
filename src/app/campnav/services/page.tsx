...
const SERVICES = [
  ...
  {
    label: "HSE Report",
    href: "/campnav/hse/report",
    icon: ShieldAlert,
  },
  {
    label: "Facility Booking",
    href: "/campnav/facilities/booking",
    icon: Calendar,
  },
]
...
export default function ServicesPage() {
  ...
  return (
    <div className="space-y-6 pb-4">
      ...
      <Link href="/campnav/requests" className="block">
