    ...
    <div className="space-y-6 pb-4">
      ...
      <section className="mt-2 space-y-4">
        <div className="flex items-center justify-between px-1">
          ...
          <Link href="/campnav/updates" className="text-xs font-medium text-muted-foreground hover:text-primary transition-colors">View All</Link>
        </div>
                ...
                >
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mt-2 pt-3 border-t border-border/50">
                      ...
                      <Link href={`/campnav/updates/announcements/${announcement._id}`} className="text-[11px] font-semibold text-primary flex items-center gap-1 hover:underline">
                        Read details
                      </Link>
                    </div>
                  </div>
      ...
      {user && user.role === "camper" && userRequests && userRequests.length > 0 && (
        <section className="space-y-4">
          <div className="flex items-center justify-between px-1">
            ...
            <Link href="/campnav/requests" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
      ...
      <section className="mt-2 space-y-3">
        <div className="flex items-center justify-between px-1">
          ...
          <Link href="/campnav/updates?tab=activities&view=calendar" className="text-xs font-medium text-primary">View Calendar</Link>
        </div>
        <div className="flex gap-3 overflow-x-auto pb-1 no-scrollbar">
          {activities.length === 0 ? (
            ...
            activities.map((event: any) => (
              <Link
                key={event._id}
                href={`/campnav/updates/activities/${event._id}`}
