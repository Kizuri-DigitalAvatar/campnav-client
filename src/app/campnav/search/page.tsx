    ...
    if (!hasResults) {
        return (
            <div className="flex flex-col items-center justify-center py-20 text-center px-6">
                ...
                <Link href="/campnav" className="mt-8 text-primary font-semibold hover:underline flex items-center gap-2">
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {results.announcements.map((announcement) => (
                            <Link key={announcement._id} href={`/campnav/updates?id=${announcement._id}`}>
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {results.products.map((product) => (
                            <Link key={product._id} href="/campnav/shop">
