        ...
        {activeTab === "announcements" && (
          <div className="space-y-4">
            {announcements.map((item: any) => (
              <Link key={item._id} href={`/campnav/updates/announcements/${item._id}`}>
                <Card
            ...
            {viewMode === "list" ? (
              <div className="space-y-4">
                {activities.map((activity: any) => (
                  <Link key={activity._id} href={`/campnav/updates/activities/${activity._id}`}>
          ...
          sortedActivities.map((activity, idx) => {
            ...
            return (
              <div key={activity._id} className="relative pl-6 pb-2">
                ...
                <Link href={`/campnav/updates/activities/${activity._id}`}>
